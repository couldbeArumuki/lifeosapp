...
const Modal = ({ isOpen, onClose, title, children, size = 'md' }) => {
  ...
  return (
    <>
      ...
      <div role="dialog" aria-modal="true" aria-labelledby="modal-title" className={`fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[51] ${sizeWidths[size]} max-h-[90vh] flex flex-col bg-white dark:bg-gray-800 rounded-2xl shadow-2xl`}>
